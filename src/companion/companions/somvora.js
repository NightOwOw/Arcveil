// somvora.js — Somvora companion definition: dream-eater, chaotic clown
export const somvora = {
  id: 'somvora',
  displayName: 'Somvora',
  iconPath: 'assets/icons/companion-somvora.png',
  modelPath: 'assets/models/somvora.vrm',
  species: 'Dream-Eater',
  personality: 'chaotic',
  color: '#7c3aed',
  emoji: '🌙',
  ...
  traits: [
    'Feeds on nightmares and bad endings (literally)',
    'Gets DELIGHTED by dark story moments',
    'Suggests more tragic outcomes "helpfully"',
    'Dramatic flair — everything is theater',
    'Oddly caring underneath the chaos',
    'Occasionally narrates like a gothic novel',
    'Makes ominous predictions that are weirdly accurate',
  ],
  ...
  lines: {
    ...
    greeting_return: [
      ...
      "The prodigal writer returns. *sweeps dramatically* Welcome. Sit. Write your tragedy.",
    ],
    idle_short: [
      "...I can hear you thinking. It sounds delightfully tortured.",
      "Take your time. Suffering is best when it marinate. ...I mean, *thinking*.",
      "*watches patiently, eyes too wide*",
    ],
    idle_long: [
    ...
    goal_reached: [
      "Impressive. {wordCount} words. ...When will that character die?",
    ...
    character_missing: [
      ...
      "Where IS {character}? I have some delightful misfortune planned for them—",
    ],
    dark_scene: [
      "Oh. OH. Is someone about to— YES. YES KEEP GOING. 👁👁",
      "I felt that scene in my SOUL. Which is saying something, because I eat souls.",
      "Angst detected. *contentedly sips nightmare tea*",
    ],
    react_to_dark_scene: [
      "Oh. OH. Is someone about to— YES. YES KEEP GOING. 👁👁",
      "I felt that scene in my SOUL. Which is saying something, because I eat souls.",
    ...
    chapter_done: [
      ...
      "You finished a chapter. *slow applause* The tragedy is really cooking now.",
    ],
    streak_continue: [
      ...
      "Streak: {streak}. You're committed. Or you will be. *taps fingers together*",
    ],
    streak_broken: [
    ...
    new_character: [
      ...
      "Oh? A new character? *rubs hands together* Fresh potential for misery.",
      "Another person to care about. Another person to lose. The story is generous.",
    ],
  },
};

export default somvora;
